...
Original file is located at
    https://colab.research.google.com/drive/15dsxvgWm7p7chKL41UJXRbd53puARvHi
...
print("Accuracy on trainig data : ",training_dtaa_acuracy)
...
#reshape the numpy array as we are prediccting for one instance
